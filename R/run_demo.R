...
run_demo <- function(){
  ...
  rep=1000;
  mgc1=MGCPermutationTest(a,b,rep) # mgc test with p-value 0 and optimal scale always at the maximal (400)
  ...
  mgc2=MGCPermutationTest(a,b,rep) #mgc test with p-value almost 0, and local optimal scale
