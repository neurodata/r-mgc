...
sims.opts <- list(list(n=n, d=d, K=2, mean.scale=0, cov.scale=20), list(n=n, d=d, K=2, mean.scale=1, cov.scale=20), list(n=n, d=d, K=5, mean.scale=1, cov.scale=20),#list(n=n, d=d, K=2, cov.scale=4),
                  list(n=n, d=d, K=2, cov.scale=5), list(n=n, d=d, K=2))#,
                  #list(n=n, d=d))
sims.titles = c("(A) No Signal", "(A) 2 Class, Linear", "(B) 5 Class, Linear", #"(C) 5 Class, Exponential",
                "(D) 2 Class, Cross", "(E) 2 Class, Spherical")#, "(F) 5 Class, Beta")
plots <- list()
...
grid.arrange(arrangeGrob(grobs=plots, ncol=3), sim_leg, heights=c(0.9, 0.05))
```
