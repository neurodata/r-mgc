...
sims.opts <- list(list(d=d, K=2, mean.scale=0, cov.scale=20), list(d=d, K=2, mean.scale=1.2, cov.scale=20),
                  list(d=d, K=5, mean.scale=1.2, cov.scale=20),#list(n=n, d=d, K=2, cov.scale=4),
